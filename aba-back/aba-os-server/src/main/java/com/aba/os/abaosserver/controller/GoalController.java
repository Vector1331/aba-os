...
public class GoalController {
    ...
    public ResponseEntity<ApiResponse<GoalResponse>> getGoalDetail(@PathVariable UUID id) {
    ...
    public ResponseEntity<ApiResponse<String>> deleteGoal(@PathVariable UUID id) {
